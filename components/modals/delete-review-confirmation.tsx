    ...
    <Modal
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.title}>Excluir Revisão</Text>
          
          <Text style={styles.message}>
            Tem certeza que deseja excluir a revisão "{topicName}"?{'\n'}
            Todas as datas de revisão serão removidas e esta ação não pode ser desfeita.
          </Text>
